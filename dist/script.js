...
var changeModalState = function changeModalState(state) {
  var windowForm = document.querySelectorAll('.balcon_icons_img'),
      ...
      windowHType = document.querySelectorAll('#view_type'),
  ...
  bindActionToElems('change', windowHType, 'type');
...
var images = function images() {
  // api которое позволяет создавать новые блоки
  ...
  imgPopup.appendChild(bigImage); //оброботчик события который будем вешать на всю секцию 
...
var modals = function modals() {
  ...
  bindModel('.popup_calc_profile_button', '.popup_calc_end', '.popup_calc_end_close', false); // showModalByTime('.popup', 3000)
};
...
var timer = function timer(id, deadline) {
  ...
  var setClock = function setClock(selector, entTime) {
    var timer = document.querySelector(selector),
        days = timer.querySelector('#days'),
        hours = timer.querySelector('#hours'),
        minutes = timer.querySelector('#minutes'),
        seconds = timer.querySelector('#seconds'),
        timeInterval = setInterval(updateClock, 1000); // сколько времени осталось до дедлайна 

    updateClock();

    function updateClock() {
      var time = getTimeRemaining(entTime);
